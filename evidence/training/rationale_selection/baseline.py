...
parser.add_argument('--corpus', type=str, default='/data/scratch/acw560/two-step/data1/corpus.jsonl')
parser.add_argument('--claim-train', type=str, default='/data/scratch/acw560/two-step/data1/claims_train.jsonl')
parser.add_argument('--claim-dev', type=str, default='/data/scratch/acw560/two-step/data1/claims_dev.jsonl')
parser.add_argument('--dest', type=str, required=True, help='Folder to save the weights')
parser.add_argument('--model', type=str, default='roberta-large')
parser.add_argument('--epochs', type=int, default=20)
parser.add_argument('--batch-size-gpu', type=int, default=1, help='The batch size to send through GPU')
