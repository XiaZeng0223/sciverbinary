...
parser.add_argument('--abstract', type=str, default='./test_abstract_transformers/abstract_retrieval.jsonl')
parser.add_argument('--model', type=str, default='./data_rationale_training/epoch-14-acc-8813')
parser.add_argument('--output', type=str, default='./test_rationale')
