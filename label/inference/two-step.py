...
parser.add_argument('--model_n', type=list, default='./model/neutral_detector')
parser.add_argument('--model_s', type=list, default='./model/support_detector')
...
if __name__ == '__main__':
    ...
    config_n = AutoConfig.from_pretrained(model_n_path, num_labels=2)
    ...
    config_s = AutoConfig.from_pretrained(model_s_path, num_labels=2)
